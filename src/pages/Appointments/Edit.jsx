...
export default function EditAppointment() {
  ...
  // useEffect to fetch existing appointment data on component mount and reset the form with fetched values
  useEffect(() => {
  ...
  // onSubmit: handles form submission by patching appointment data to API and navigating back to appointments list
